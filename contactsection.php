...
<body>
    ...
    <!-- FORM -->
    <form id="form" class="topBefore" method="post" name="myemailform" action="form-to-email">
...
$email_from = 'contact@ritikamaknoor.com';//<== update the email address
$email_subject = "New Form submission";
$email_body = "You have received a new message from the user $name.\n".
    "Here is the message:\n $message".
    
$to = "contact@ritikamaknoor.com";//<== update the email address
